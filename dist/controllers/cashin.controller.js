...
export async function cashInController(req, res) {
    ...
    try {
        ...
        session.endSession();
        return res.status(500).json({ error: "TRANSACTION_FAILED", details: err.message });
    }
}
//# sourceMappingURL=cashin.controller.js.map